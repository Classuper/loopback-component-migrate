...
var requireInterop = require('interop-require');
...
module.exports = function(Migration, options) {
  ...
  Migration.migrateByName = function(name, record, cb) {
    ...
    try {
      requireInterop(scriptPath).up(Migration.app, function(err) {
        if (record) {
          Migration.create({
            name: name,
            realm: realm,
      ...
      scriptsToRun.forEach(function(localScriptName) {
        migrationCallStack.push(function() {
          ...
          try {
            ...
            requireInterop(scriptPath)[upOrDown](Migration.app, function(err) {
              if (err) {
                Migration.finish(err);
                return cb(err);
              } else if (upOrDown === 'up') {
